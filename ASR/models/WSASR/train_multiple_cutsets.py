...
from asr_datamodule_multiple_cutsets import AsrDataModule
...
def get_parser():
    ...
    parser.add_argument(
        "--start-epoch",
        type=int,
        default=config['train']['start_epoch'],
    ...
    parser.add_argument(
        "--feature-dim",
        type=int,
        default=config['parameters']['feature-dim'],
    ...
    parser.add_argument(
        "--initial-lr",
        type=float,
        default=config['parameters']['initial_lr'],
    ...
    parser.add_argument(
        "--lr-epochs",
        type=float,
        default=config['parameters']['lr_epochs'],
    ...
    parser.add_argument(
        "--att-rate",
        type=float,
        default=config['parameters']['attention_rate'],
    ...
    parser.add_argument(
        "--num-decoder-layers",
        type=int,
        default=config['train']['num_decoder_layers'],
    ...
    parser.add_argument(
        "--use-fp16",
        type=str2bool,
        default=config['parameters']['use_fp16'],
...
def run(rank, world_size, args):
    ...
    train_cuts_1 = asr_data.train_cuts()
    train_cuts_2 = asr_data.train_cuts_2()
    ...
    train_cuts_1 = train_cuts_1.filter(remove_short_and_long_utt)
    train_cuts_2 = train_cuts_2.filter(remove_short_and_long_utt)
    ...
    train_dl = asr_data.train_dataloaders(
        train_cuts_1, train_cuts_2, sampler_state_dict=sampler_state_dict
    )

    valid_cuts = asr_data.dev_cuts()
    valid_dl = asr_data.valid_dataloaders(valid_cuts)
