...
def FM_store_predictions(results, char_level: bool = False):
    """
    Function source: icefall/icefall/utils.py line 514
    Save predicted results to a file.
    """
    with open("Prediction_compilation.txt", "w", encoding="utf8") as f:
