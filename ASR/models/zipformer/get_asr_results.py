...
for i in range(17, 20): 
    ...
    cmd_string = f"python scripts/decode.py --epoch {str(i)}"
    print(cmd_string)
    ...
    # exp_type = config['datamodule']['lang_dir'].split('/')[-2]

    out_handle = codecs.open(f"{config['train']['exp_dir']}/zul_nchlt_testset_WER_compilation.txt", "a", "utf-8") 
