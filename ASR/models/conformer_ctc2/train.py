...
"""
# from torchinfo import summary  ### FM: used this library to print neural network structure
    ...
    params = AttributeDict(
        {
            ...
            "log_interval": 1,
            "reset_interval": 200,
            "valid_interval": 800,  # For the 100h subset, use 800 - not the default 3000 JB
...
def run(rank, world_size, args):
    ...
    train_cuts = asr_data.train_cuts()
