...
def get_parser():
    ...
    parser.add_argument(
        ...
        type=str,
        default="<SIL>",
        help="Remove the silence labels from the recognised and hyp strings",
    )
    parser.add_argument(
        "--epoch",
        type=int,
        default=config['decode']['epoch'],
    ...
    parser.add_argument(
        "--use-averaged-model",
        type=str2bool,
        default=config['decode']['use_averaged_model'],
    ...
    parser.add_argument(
        "--num-decoder-layers",
        type=int,
        default=config['decode']['num_decoder_layers'],
    ...
    parser.add_argument(
        "--num-paths",
        type=int,
        default=config['decode']['num_paths'],
    ...
    parser.add_argument(
        "--nbest-scale",
        type=float,
        default=config['decode']['nbest_scale'],
    ...
    parser.add_argument(
        "--lang-dir",
        type=str,
        default=config['datamodule']['lang_dir'],
        help="The lang dir",
    )
    ...
    parser.add_argument(
        "--lm-dir",
        type=str,
        default=config['datamodule']['lm_dir'],
    ...
    parser.add_argument(
        "--rnn-lm-exp-dir",
        type=str,
        default=config['decode']['rnn_lm_dir'],
    ...
    parser.add_argument(
        "--rnn-lm-epoch",
        type=int,
        default=config['decode']['rnn_lm_epoch'],
        help="""Used only when --method is rnn-lm.
    ...
    parser.add_argument(
        "--rnn-lm-avg",
        type=int,
        default=config['decode']['rnn_lm_avg'],
        help="""Used only when --method is rnn-lm.
    ...
    parser.add_argument(
        ...
        type=int,
        default=config['decode']['rnn_lm_embedding_dim'],
    ...
    parser.add_argument(
        "--rnn-lm-hidden-dim",
        type=int,
        default=config['decode']['rnn_lm_hidden_dim'],
    ...
    parser.add_argument(
        "--rnn-lm-num-layers",
        type=int,
        default=config['decode']['rnn_lm_num_layers'],
        help="Number of RNN layers the model",
    )
    parser.add_argument(
        "--rnn-lm-tie-weights",
        type=str2bool,
        default=config['decode']['rnn_lm_tie_weights'],
        ...
        if hyps_dict is not None:
            for lm_scale, hyps in hyps_dict.items():
                ...
                for cut_id, hyp_words, ref_text in zip(cut_ids, hyps, texts):
                    ...
                    #Removing silences from decode
                    ref_words = list(filter(lambda a: a != params.exclude_sil, ref_words))
                    hyp_words = list(filter(lambda a: a != params.exclude_sil, hyp_words))
...
def main():
    ...
    test_cuts = asr_data.test_cuts()
    test_cuts_dl = asr_data.test_dataloaders(test_cuts)
