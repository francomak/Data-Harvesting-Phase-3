...
#JB parameters
lang=eng
JB_test_set=test_${lang}
JB_dev_set=dev_${lang}
...
test_sets="$JB_dev_set $JB_test_set"
...
local/nnet3/run_ivector_common.sh --stage $stage --nj $nj \
                                  ...
                                  --JB-test-set $JB_test_set \
                                  --JB-dev-set $JB_dev_set\
                                  --lang $lang 
...
#JB changed to CPU training
  ...
  steps/nnet3/train_dnn.py --stage=$train_stage \
    ...
    --use-gpu=false --feat-dir=$train_data_dir \
    --ali-dir=$ali_dir \
    --lang=data/lang \
