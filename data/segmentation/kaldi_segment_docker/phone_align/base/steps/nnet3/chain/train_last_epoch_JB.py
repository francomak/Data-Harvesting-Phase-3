...
def train(args, run_opts):
    ...
    #num_iters = 263 + 65 #JB - Set the number of iterations for this last epoch nr 5 to same number of iterations per epoch as initial model
    #num_iters = 275 + 68 #For eng model - adding a 5th epoch with constant number of additional iterations
    
    #num_iters = 275 + 23 #For eng model - adding a 5th epoch with constant number of additional iterations -10% dur - 0.5 itrs
    #num_iters = 275 + 46 #For eng model - adding a 5th epoch with constant number of additional iterations -10% dur
    #num_iters = 275 + 76 #For eng model - adding a 5th epoch with constant number of additional iterations - 20% NCHLT2 dur
    #num_iters = 275 + 350 #For eng model - adding a 5th epoch with constant number of additional iterations - 30% NCHLT2 dur
    
    num_iters = 263 + 32 #For zul model - adding a 5th epoch with constant number of additional iterations - 0.5x65 itrs (approx 4 hours of adapt data)
    #num_iters = 263 + 65 #For zul model - adding a 5th epoch with constant number of additional iterations - 65 itrs (approx 4 hours of adapt data)
    ...
    for iter in range(264,num_iters): #kids - JB
    #for iter in range(350,num_iters): #NCHLT2 - JB
