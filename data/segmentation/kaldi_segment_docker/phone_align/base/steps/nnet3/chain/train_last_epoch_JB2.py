...
def train(args, run_opts):
    ...
    #num_iters = 275 + 46 #For eng model - adding a 5th epoch with constant number of additional iterations
    #num_iters = 275 + 76 #For eng model - adding a 5th epoch with constant number of additional iterations - 20% NCHLT2 dur
    num_iters = 275 + 347 #For eng model - adding a 5th epoch with constant number of additional iterations - 30% NCHLT2 dur
    ...
    #for iter in range(276,num_iters): #NCHLT2 - JB
    for iter in range(620,num_iters): #NCHLT2 - JB
