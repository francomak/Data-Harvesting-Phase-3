...
cut -d' ' -f2- data/train_${lang}/text | sed -e 's:^:<s> :' -e 's:$: </s>:' > $srcdir/lm_train.text

/home/bagher/kaldi-trunk/tools/irstlm/bin/build-lm.sh -i $srcdir/lm_train.text -n 2 -o $tmpdir/lm.ilm.gz
