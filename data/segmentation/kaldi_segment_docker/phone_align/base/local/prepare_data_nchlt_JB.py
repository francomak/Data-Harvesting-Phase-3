...
def prepareData(audio_dir, trans_dir, lang, list_dir):
    ...
    train_list = os.path.join(list_dir, "".join(["nchlt_",lang,".trn.lst"]))
    ...
    test_list = os.path.join(list_dir, "".join(["nchlt_",lang,".tst.lst"]))
    ...
    os.makedirs(dev_dir)
    dev_list = os.path.join(list_dir, "".join(["nchlt_",lang,".dev.lst"]))
